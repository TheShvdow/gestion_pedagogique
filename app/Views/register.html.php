					...
					<div class="gap-10 divide-y divide-gray-200 ">
						<div class="flex-1 justify-between py-8 text-base leading-10 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            ...
                            <div class="relative my-10">
								<input autocomplete="off" id="nom" name="nom" required type="nom" class="peer placeholder-transparent h-10 w-full text-white bg-transparent border-b focus:outline-none focus:border-rose-600" placeholder="Enter Name" />
								<label for="nom" class="absolute left-0 -top-3.5 text-white text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-white peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-white  peer-focus:text-sm">Nom</label>
							</div>
                            <!-- champs prenom -->
                            <div class="relative my-10">
								<input autocomplete="off" id="prenom" name="prenom" required type="prenom" class="peer placeholder-transparent h-10 w-full text-white bg-transparent border-b focus:outline-none focus:borer-rose-600" placeholder="Enter First Name" />
								<label for="prenom" class="absolute left-0 -top-3.5 text-white text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-white peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-white  peer-focus:text-sm">prenom</label>
							</div>
                            <!-- champs tel -->
                            <div class="relative my-10">
								<input autocomplete="off" id="telephone" name="telephone" required type="telephone" class="peer placeholder-transparent h-10 w-full text-white bg-transparent border-b focus:outline-none focus:borer-rose-600" placeholder="Téléphone" />
								<label for="telephone" class="absolute left-0 -top-3.5 text-white text-sm peer-placeholder-shown:text-base peer-placeholder-shown:text-white peer-placeholder-shown:top-2 transition-all peer-focus:-top-3.5 peer-focus:text-white  peer-focus:text-sm">telephone</label>
							</div>
                            <!-- champs username -->
                            <div class="relative my-10">
								<input autocomplete="off" id="email" name="username"  required type="email" class="peer placeholder-transparent h-10 w-full text-white bg-transparent border-b focus:outline-none focus:borer-rose-600" placeholder="Email address" />
						...
						<div class="relative flex justify-between no-border">
							<button type="submit" class="bg-white text-[#295677] rounded-sm h-10 w-28 self-center">S'inscrire</button>
						</div>
				</div>
			</div>
		</div>
